use crate::models::{
    Borrow, Candle, CandleForSma, CandleForStrategy, CandleWithAtr, CandleWithIncrement,
    CandleWithProfit, Currency, Lend, Strategy, Symbol, SymbolIncrement, Ticker, Total,
    calc_strategy, calculate_atr, round_to_decimal,
};
use crate::templates::{
    BorrowTemplate, BorrowsTemplate, CandleTemplate, CandlesSmaTemplate, CandlesTemplate,
    CurrenciesTemplate, IndexTemplate, LendTemplate, LendsTemplate, OneStrategyTemplate,
    StrategyTemplate, SymbolsTemplate, TickersTemplate,
};
