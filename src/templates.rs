use crate::models::{
    Borrow, Candle, CandleForSma, CandleWithAtr, CandleWithProfit, Currency, Lend, PgConnection,PgStatStatements,
    PgTableIndex, PgTableInfo, SMAResult, Strategy, Symbol, Ticker, Total,
};
use askama::Template;
...
//
#[derive(Template)]
#[template(path = "sma/candles.html")]
pub struct CandlesSmaTemplate {
    pub symbols: Vec<(usize, CandleForSma)>,
    pub elapsed_ms: u128,
}
#[derive(Template)]
